                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12 copyright text-center">
                                <p>© 2023 Violette Labs Private Ltd. All rights reserved.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <footer className="py-5">
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <div className="col-md-2 col-sm-6">
                            <div className="footer-menu">
                                <h5 className="widget-title">Partner Service</h5>
                                <ul className="menu-list list-unstyled">
                                    <li className="menu-item">
                                        <a href="#" className="nav-link">FAQ</a>
                                    </li>
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6">
                            <div className="footer-menu">
                                ...
                                <form className="d-flex mt-3 gap-0" role="newsletter">
                                    <input className="form-control rounded-start rounded-0 bg-light"
                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-md-12 copyright text-center">
                            <p>© 2023 Violette Labs Pvt. Ltd. All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
